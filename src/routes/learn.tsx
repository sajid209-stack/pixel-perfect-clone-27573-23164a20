...
export const Route = createFileRoute("/learn")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Learn — Investor Education | Dhaka Stock Exchange" },
      {
        property: "og:description",
        content: "Investor education and capital-market training resources from the Dhaka Stock Exchange, including the DSE Training Academy (DTA).",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Learn — Investor Education | Dhaka Stock Exchange" },
      {
