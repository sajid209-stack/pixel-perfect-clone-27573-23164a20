...
export const companies: Company[] = [
  {
    code: "BATBC", name: "British American Tobacco Bangladesh", sector: "Food & Allied", board: "Main Board", category: "A",
    ...
    weekHigh52: 248, weekLow52: 188.5, faceValue: 10, paidUpCapital: 5400000000, nav: 102.50,
    description: "BAT Bangladesh is a leading FMCG company, manufacturing and marketing cigarettes under brands including Benson & Hedges, John Player Gold Leaf, and Camel.",
    founded: 1972, listingYear: 1977,
    scripCode: 14259, instrumentType: "Equity", debutDate: "—",
    freeFloatMarketCap: 30204000000,
    operationalStatus: "Active",
    loanStatus: { shortTerm: 920, longTerm: 480 },
    creditRating: { shortTerm: "ST-1", longTerm: "AAA" },
    companySecretary: { name: "Md. Azizur Rahman, FCS", email: "company.secretary@bat.com", phone: "+880 2 8836510" },
    registeredOffice: "New DOHS Road, Mohakhali, Dhaka 1206, Bangladesh",
    factoryAddress: "BAT Bangladesh Factory, Mohakhali, Dhaka — and Savar, Dhaka",
    phone: "+880 2 8836510", fax: "+880 2 8836511", email: "investor.relations@bat.com",
    psiUrl: "#", financialStatementsUrl: "#",
    agmDate: "12 June 2025", yearEnd: "31 December",
    hq: "Dhaka", website: "batbangladesh.com",
    sharePattern: pat({ sponsor: 72.91, government: 0.64, institution: 14.36, foreign: 3.20 }),
    dividendHistory: [
      { year: 2025, cash: 30,  stock: 0, yieldPct: 2.14, rights: "n/a" },
      { year: 2024, cash: 300, stock: 0, yieldPct: 1.92, rights: "n/a" },
      { year: 2023, cash: 100, stock: 0, yieldPct: 1.78, rights: "n/a" },
      { year: 2022, cash: 600, stock: 0, yieldPct: 1.65, rights: "n/a" },
      { year: 2021, cash: 600, stock: 0, yieldPct: 1.60, rights: "n/a" },
    ],
    interimFinancials: [
      { metric: "Basic EPS",                q1: 3.81, q2: 4.10, half: 7.91, q3: 3.95, nine: 11.86, annual: 14.90 },
      { metric: "Diluted EPS",              q1: 3.78, q2: 4.06, half: 7.84, q3: 3.92, nine: 11.76, annual: 14.78 },
      { metric: "EPS (continuing ops)",     q1: 3.81, q2: 4.10, half: 7.91, q3: 3.95, nine: 11.86, annual: 14.90 },
      { metric: "Market price (period-end)",q1: 198.40, q2: 204.10, half: 204.10, q3: 209.20, nine: 209.20, annual: 211.50 },
    ],
    multiYearFinancials: [
      { year: 2021, epsBasic: 11.20, nav: 78.40,  profit: 6048, comprehensive: 6052, reserve: 24800, oci: 4 },
      { year: 2022, epsBasic: 13.85, nav: 85.10,  profit: 7479, comprehensive: 7470, reserve: 27600, oci: -9 },
      { year: 2023, epsBasic: 12.40, nav: 90.20,  profit: 6696, comprehensive: 6710, reserve: 29200, oci: 14 },
      { year: 2024, epsBasic: 13.92, nav: 96.80,  profit: 7517, comprehensive: 7505, reserve: 31250, oci: -12 },
      { year: 2025, epsBasic: 14.90, nav: 102.50, profit: 8046, comprehensive: 8060, reserve: 33420, oci: 14 },
    ],
    peTrend: [
      { date: "May 28", audited: 14.05, unaudited: 13.48 },
      { date: "May 29", audited: 14.09, unaudited: 13.52 },
      { date: "Jun 01", audited: 14.12, unaudited: 13.55 },
      { date: "Jun 02", audited: 14.15, unaudited: 13.58 },
      { date: "Jun 03", audited: 14.18, unaudited: 13.61 },
      { date: "Jun 04", audited: 14.20, unaudited: 13.63 },
    ],
    recentAnnouncements: [
      { type: "Dividend", date: "Jun 03", summary: "Final cash dividend of 30% declared for FY2025" },
